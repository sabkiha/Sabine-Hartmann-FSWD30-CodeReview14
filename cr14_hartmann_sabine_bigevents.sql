...
--
CREATE DATABASE IF NOT EXISTS `cr14_hartmann_sabine_bigevents` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cr14_hartmann_sabine_bigevents`;
